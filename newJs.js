...
const guestsDB = {
    ...
    29: ["Леонид", "Галина"],
    30: ["Сергей", "Светлана"],
    31: ["Саня", "Даша которые Питерские"],
    32: ["Никита который фармацевт"],
    33: ["Паха который daylex"],
    34: ["Тигр-паркур"],
    35: ["Киря", "Софья"],
    36: ["Денис который уехал", "Дарья"],
    37: ["Паха", "Настя"],
    38: ["Никита который Barabylka2012"],
    39: ["Аркадий"],
    40: ["Жека который мотоциклы"],
    40: ["Ольга", "Андрей"],
};

function detectGender(name) {
    const lowerName = name.toLowerCase();
    const maleExceptions = ["николай", "никита", "саша", "женя", "валентин", "илья", "симухин", "назарий", "ежков", "паха", "тигр", "аркадий"];
